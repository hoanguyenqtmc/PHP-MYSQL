    ...
    <body>
        ...
        <div>
          <?php if (isset($_SESSION['success'])) :?>
            <p class="text-danger"> <?php $message=$_SESSION['success']; echo "<script type='text/javascript'>alert('$message');</script>"; ?></p>
          ...
          <div class="product-description">
            <div class="product-label">
              <div class="product-name">
                <a href="chi-tiet.php?ma_hh=<?=$ma_hh?>"><h1><?=$ten_hh?></h1></a>
